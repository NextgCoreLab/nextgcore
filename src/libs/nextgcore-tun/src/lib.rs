...
///
/// Linux:
/// - nextgcore_tun_read(16bytes): NEXTGCORE_GTPV1U_5GC_HEADER_LEN(16bytes)
/// - nextgcore_tun_write(0bytes): No Need for headroom
///
/// Mac OS X:
/// - nextgcore_tun_read(12bytes): NEXTGCORE_GTPV1U_5GC_HEADER_LEN(16bytes) - Null/Loopback(4bytes)
/// - nextgcore_tun_write(4bytes): Null/Loopback(4bytes)
