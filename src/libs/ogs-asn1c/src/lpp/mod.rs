...
//! encoder/decoder.
//!
//! # v1 FOUNDATION scope (Wave-3 lmfd-LIB-02b / LIB-02d)
//!
//! This chunk covers the message envelope plus the complete E-CID location loop:
//!
...
//!   (request / provide location information).
...
//!
//! Capabilities, assistance data, A-GNSS, OTDOA, and the other positioning
//! methods are carried by follow-on chunks; where they appear as root optionals
//! they are modeled UNSUPPORTED-ABSENT (never emitted; rejected on decode).
//!
