...
mod ng_setup_cross_codec {
    ...
    //!
    //! These pin the wire bytes nextgcore-ngap produces for the NG Setup Request and
    ...
    // ------------------------------------------------------------------
    //
    // Pins the wire bytes nextgcore-ngap produces for an InitialContextSetupRequest
