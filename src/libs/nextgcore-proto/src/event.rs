...
pub const EVENT_NAME_SBI_SERVER: &str = "NEXTGCORE_EVENT_NAME_SBI_SERVER";
pub const EVENT_NAME_SBI_CLIENT: &str = "NEXTGCORE_EVENT_NAME_SBI_CLIENT";
pub const EVENT_NAME_SBI_TIMER: &str = "NEXTGCORE_EVENT_NAME_SBI_TIMER";

/// FSM signal names
pub const FSM_NAME_INIT_SIG: &str = "NEXTGCORE_FSM_INIT_SIG";
pub const FSM_NAME_ENTRY_SIG: &str = "NEXTGCORE_FSM_ENTRY_SIG";
pub const FSM_NAME_EXIT_SIG: &str = "NEXTGCORE_FSM_EXIT_SIG";
