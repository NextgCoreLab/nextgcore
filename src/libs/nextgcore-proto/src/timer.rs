...
pub const TIMER_NAME_NF_INSTANCE_NO_HEARTBEAT: &str = "NEXTGCORE_TIMER_NF_INSTANCE_NO_HEARTBEAT";
pub const TIMER_NAME_NF_INSTANCE_VALIDITY: &str = "NEXTGCORE_TIMER_NF_INSTANCE_VALIDITY";
pub const TIMER_NAME_SUBSCRIPTION_VALIDITY: &str = "NEXTGCORE_TIMER_SUBSCRIPTION_VALIDITY";
pub const TIMER_NAME_SUBSCRIPTION_PATCH: &str = "NEXTGCORE_TIMER_SUBSCRIPTION_PATCH";
pub const TIMER_NAME_SBI_CLIENT_WAIT: &str = "NEXTGCORE_TIMER_SBI_CLIENT_WAIT";
...
pub fn timer_get_name(timer_id: TimerId) -> &'static str {
    match timer_id {
        TimerId::Base => "NEXTGCORE_TIMER_BASE",
