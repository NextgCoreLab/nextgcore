...
use crate::kdf::ogs_kdf_ansi_x963;
...
pub fn ecies_profile_a_encrypt_with_ephemeral(
    ...
    let (enc_key, icb, mac_key) = ogs_kdf_ansi_x963(shared.as_bytes(), eph_pub.as_bytes());
...
pub fn ecies_profile_a_decrypt(
    ...
    let (enc_key, icb, mac_key) = ogs_kdf_ansi_x963(shared.as_bytes(), ephemeral_pub);
