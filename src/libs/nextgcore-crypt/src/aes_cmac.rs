//! AES-CMAC
//!
//! Wrapper around the `cmac` crate to match the interface of lib/crypt/nextgcore-aes-cmac.c
//!
...
mod tests {
    ...
    fn test_cmac_verify_invalid() {
        ...
        let wrong_cmac = [
            0x00, 0x0a, 0x16, 0xb4, 0x6b, 0x4d, 0x41, 0x44, 0xf7, 0x9b, 0xdd, 0x9d, 0xd0, 0x4a,
            0x28, 0x7c,
        ];

        assert_eq!(
            aes_cmac_verify(&wrong_cmac, &TEST_KEY, &msg),
            Err(CmacError::InvalidCmac)
        );
    }
}
