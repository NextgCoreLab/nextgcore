...
mod tests {
    ...
    fn encode_initiating_pdu(
        procedure_code: ogs_asn1c::ngap::types::ProcedureCode,
        container: ogs_asn1c::ngap::ies::ProtocolIeContainer,
    ) -> Vec<u8> {
        use ogs_asn1c::ngap::pdu::{InitiatingMessage, InitiatingMessageValue, NgapPdu};
