//! FFI bindings for nextgcore-crypt library
//!
...
extern "C" {
    ...
    /// AES-CMAC
    pub fn nextgcore_aes_cmac_calculate(
...
extern "C" {
    /// Base64 encode
    pub fn nextgcore_base64_encode(
        input: *const u8,
        input_len: usize,
        output: *mut u8,
        output_len: *mut usize,
    ...
    /// Base64 decode
    pub fn nextgcore_base64_decode(
        input: *const u8,
        input_len: usize,
        output: *mut u8,
        output_len: *mut usize,
