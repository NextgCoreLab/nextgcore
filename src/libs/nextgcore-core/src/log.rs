//! Logging utilities
//!
//! Exact port of lib/core/nextgcore-log.h and nextgcore-log.c
...
/// Initialize logging
pub fn nextgcore_log_init() {
    env_logger::init();
}

/// Logging macros matching C implementation
#[macro_export]
macro_rules! nextgcore_fatal {
    ($($arg:tt)*) => {
