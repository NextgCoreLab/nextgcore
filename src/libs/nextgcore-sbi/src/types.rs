...
/// SBI Service Types - matches nextgcore_sbi_service_type_e
...
pub enum SbiServiceType {
    ...
    NamfLoc,
    NamfOam,
    /// TS 29.518 Namf_MBSBroadcast (`{apiRoot}/namf-mbs-bc/v1`), TS 23.501
    /// Table 7.2.2-1. The MB-SMF discovers the AMF by this service NAME, so the
    /// service has to be nameable here to reach an NFProfile at all (#392).
    NamfMbsBc,
    /// TS 29.518 Namf_MBSCommunication (`{apiRoot}/namf-mbs-comm/v1`),
    /// TS 23.501 Table 7.2.2-1.
    NamfMbsComm,
    NsmfPdusession,
    NsmfEventExposure,
    NsmfNidd,
    ...
    NudrGroupIdMap,
    NlmfLoc,
    /// TS 29.572 Nlmf_Broadcast, TS 23.501 Table 7.2.25-1.
    NlmfBroadcast,
    /// TS 29.572 Nlmf_Location data exposure, TS 23.501 Table 7.2.25-1.
    NlmfDataexposure,
    N5gEirEic,
    NbsfManagement,
    ...
    NneesEasdiscovery,
    NmbsmfMbssession,
    /// TS 29.532 Nmbsmf_TMGI (Allocate/Deallocate), TS 23.247.
    NmbsmfTmgi,
    NnsacfNsac,
    ...
    NnsacfSliceEe,
    NdccfDatamanagement,
    /// TS 29.574 Ndccf_ContextManagement (`{apiRoot}/ndccf-contextdocument/v1`),
    /// TS 23.501 Table 7.2.x / TS 23.288 §8.3.
    NdccfContextdocument,
    NpinPinmanagement,
    NeasdfDnscontext,
...
impl SbiServiceType {
    ...
    pub fn to_name(&self) -> &'static str {
        match self {
            ...
            Self::NamfMbsBc => "namf-mbs-bc",
            Self::NamfMbsComm => "namf-mbs-comm",
            ...
            Self::NlmfBroadcast => "nlmf-broadcast",
            Self::NlmfDataexposure => "nlmf-dataexposure",
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        match name {
            ...
            "namf-mbs-bc" => Some(Self::NamfMbsBc),
            "namf-mbs-comm" => Some(Self::NamfMbsComm),
            ...
            "nlmf-broadcast" => Some(Self::NlmfBroadcast),
            "nlmf-dataexposure" => Some(Self::NlmfDataexposure),
            ...
            "nmbsmf-tmgi" => Some(Self::NmbsmfTmgi),
            ...
            "ndccf-contextdocument" => Some(Self::NdccfContextdocument),
...
/// SBI Application Error Numbers - matches nextgcore_sbi_app_errno_e
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
