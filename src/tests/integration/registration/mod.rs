...
use crate::common::{
    CapturedMessage, MessageCapture, MessageType, MockEnvironment, NfType, PlmnId, TestContext,
};
...
async fn test_5g_registration_flow() {
    ...
    let reg_request =
        CapturedMessage::new(MessageType::RegistrationRequest, Bytes::new(), "UE", "AMF")
            .with_field(
                "supi",
                crate::common::MessageField::String("imsi-001010000000001".to_string()),
            );
    ...
    let smc_complete =
        CapturedMessage::new(MessageType::SecurityModeComplete, Bytes::new(), "UE", "AMF");
...
async fn test_concurrent_registrations() {
    ...
    for i in 0..5 {
        ...
        let handle = tokio::spawn(async move {
            ...
            .with_field(
                "supi",
                crate::common::MessageField::String(format!("imsi-00101000000000{i}")),
            );
